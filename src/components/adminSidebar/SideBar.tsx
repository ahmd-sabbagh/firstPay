...
import { LiaComment, LiaUser } from "react-icons/lia";
...
const SideBar = () => {
  return (
    ...
    >
      <Link href={"/admin"} className="flex items-center gap-5 mb-10">
        <span>
          <MdMenuOpen className="text-3xl text-white" />
        </span>
        <span className="text-white text-2xl">{"لوحة التحكم"}</span>
      </Link>
      <Link href={"/admin/article-table"} className="flex items-center gap-5">
        <span>
          <GrArticle className="text-3xl text-white" />
        </span>
        <span className="text-white text-2xl">{"المقالات"}</span>
      </Link>
      <Link href={"/admin/comment-table"} className="flex items-center gap-5">
        <span>
          <LiaComment className="text-3xl text-white" />
        </span>
        <span className="text-white text-2xl">{"التعليقات"}</span>
      </Link>
      <Link href={"/admin/users-table"} className="flex items-center gap-5">
        <span>
          <LiaUser className="text-4xl text-white" />
        </span>
        <span className="text-white text-2xl">{"المستخدمين"}</span>
      </Link>
    </div>
  );
};
